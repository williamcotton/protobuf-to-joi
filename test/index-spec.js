...
test("protobufToJoi with test.proto", t => {
  ...
  t.test("should not validate Basic with invalid basicTestData.num", t => {
    ...
    validateDataAgainstJoiValidation(basicTestData, protobufToJoi.Basic).catch(
      err =>
        t.equal(
          err.message,
          'child "num" fails because ["num" must be a number]'
        )
    );
  });
  ...
  t.test("should not validate Basic with invalid basicTestData.payload", t => {
    ...
    validateDataAgainstJoiValidation(basicTestData, protobufToJoi.Basic).catch(
      err =>
        t.equal(
          err.message,
          'child "payload" fails because ["payload" must be a buffer or a string]'
        )
    );
  });
  ...
  t.test("should validate UTF8 with utf8TestData", t => {
    ...
    const utf8TestData = {
      foo:
        "ビッグデータ「人間の解釈が必要」「量の問題ではない」論と、もう一つのビッグデータ「人間の解釈が必要」「量の問題ではない」論と、もう一つの",
      bar: 42
    };
  ...
  t.test(
    "should not validate Nested with invalid nestedTestData.meh.num",
    t => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        nestedTestData,
        protobufToJoi.Nested
      ).catch(err =>
        t.equal(
          err.message,
          'child "meh" fails because [child "num" fails because ["num" must be a number]]'
        )
      );
    }
  );
  ...
  t.test(
    "should not validate Repeated with invalid repeatedTestData.list[0].num",
    t => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        repeatedTestData,
        protobufToJoi.Repeated
      ).catch(err =>
        t.equal(
          err.message,
          'child "list" fails because ["list" at position 0 fails because [child "num" fails because ["num" must be a number]]]'
        )
      );
    }
  );
  ...
  t.test("should validate Integers with integerPositiveNegativeTestData", t => {
    ...
    validateDataAgainstJoiValidation(
      integerPositiveNegativeTestData,
      protobufToJoi.Integers
    )
  ...
  t.test(
    "should not validate Integers with integerPositiveNegativeTestData.uint32 with negative number",
    t => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        ...
        t.equal(
          err.message,
          'child "uint32" fails because ["uint32" must be larger than or equal to 0]'
        )
      );
    }
  );
  ...
  t.test("should not validate Float with invalid floatTestData.float1", t => {
    ...
    validateDataAgainstJoiValidation(floatTestData, protobufToJoi.Float).catch(
      err =>
        t.equal(
          err.message,
          'child "float1" fails because ["float1" must be a number]'
        )
    );
  });
  ...
  t.test("should validate Packed with packedTestData.packed", t => {
    ...
    const packedTestData = {
      list: [],
      packed: ["hello world", "hej verden", "hola mundo"]
    };
  ...
  t.test("should not validate Packed with invalid packedTestData.packed", t => {
    ...
    const packedTestData = {
      packed: [123, "hej verden", "hola mundo"]
    };

    validateDataAgainstJoiValidation(
      packedTestData,
      protobufToJoi.Packed
    ).catch(err =>
      t.equal(
        err.message,
        'child "packed" fails because ["packed" at position 0 fails because ["0" must be a string]]'
      )
    );
  });
  ...
  t.test("should not validate Packed with invalid packedTestData.list", t => {
    ...
    validateDataAgainstJoiValidation(
      ...
      t.equal(
        err.message,
        'child "list" fails because ["list" at position 1 fails because [child "num" fails because ["num" must be a number]]]'
      )
    );
  });
  ...
  t.test(
    "should not validate NotPacked with invalid notPackedTestData.id",
    t => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        notPackedTestData,
        protobufToJoi.NotPacked
      ).catch(err =>
        t.equal(
          err.message,
          'child "id" fails because ["id" at position 0 fails because ["0" must be a number]]'
        )
      );
    }
  );
  ...
  t.test(
    "should validate Defaults with a defaultsTestData with all defaults",
    t => {
      t.plan(1);
  ...
  t.test(
    "should validate Defaults with a defaultsTestData with one default",
    t => {
      t.plan(1);
  ...
  t.test("should not validate Property with propertyTestData.bool_value", t => {
    ...
    validateDataAgainstJoiValidation(
      propertyTestData,
      protobufToJoi.Property
    ).catch(err =>
      t.equal(
        err.message,
        'child "bool_value" fails because ["bool_value" must be a boolean]'
      )
    );
  });

  t.test(
    "should not validate Property with invalid propertyTestData oneof",
    t => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        ...
        t.equal(
          err.message,
          '"int32_value" is not allowed. "value" must contain at least one of [bool_value, float_value, int_value, string_value]'
        )
      );
    }
  );
  ...
  t.test(
    ...
    t => {
      ...
      validateDataAgainstJoiValidation(
        ...
        t.equal(
          err.message,
          '"value" contains a conflict between exclusive peers [bool_value, float_value, int_value, string_value]'
        )
      );
    }
  );
  ...
  t.test("should validate PropertyNoOneof with propertyNoOneofTestData", t => {
    ...
    validateDataAgainstJoiValidation(
      propertyNoOneofTestData,
      protobufToJoi.PropertyNoOneof
    )
  ...
  t.test("should not validate empty strings", t => {
    ...
    validateDataAgainstJoiValidation(utf8TestData, protobufToJoi.UTF8).catch(
      err =>
        t.equal(
          err.message,
          'child "foo" fails because ["foo" is not allowed to be empty]'
        )
    );
  });

  t.test(
    "should validate empty strings when empty matcher value is passed into initialiser",
    t => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        emptyStringTestData,
        protobufToJoiWithEmpties.Strings
      )
