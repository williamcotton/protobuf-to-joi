...
console.log(protobufToJoi);
const validateDataAgainstJoiValidation = (data, joiValidation) =>
  joiValidation.validateAsync(data);
...
test("protobufToJoi with test.proto", (t) => {
  ...
  t.test("should not validate Basic with invalid basicTestData.num", (t) => {
    ...
    validateDataAgainstJoiValidation(
      basicTestData,
      protobufToJoi.Basic
    ).catch((err) => t.equal(err.message, '"num" must be a number'));
  });

  t.test(
    "should not validate Basic with invalid basicTestData.payload",
    (t) => {
      t.plan(1);
      ...
      validateDataAgainstJoiValidation(
        ...
        t.equal(err.message, '"payload" must be a buffer or a string')
      );
    }
  );
  ...
  t.test(
    ...
    (t) => {
      ...
      ).catch((err) => t.equal(err.message, '"meh.num" must be a number'));
    }
  );
  ...
  t.test(
    ...
    (t) => {
      ...
      ).catch((err) => t.equal(err.message, '"list[0].num" must be a number'));
    }
  );
  ...
  t.test(
    "should validate Integers with integerPositiveNegativeTestData",
    (t) => {
      t.plan(1);
  ...
  t.test(
    ...
    (t) => {
      ...
      validateDataAgainstJoiValidation(
        ...
        t.equal(err.message, '"uint32" must be greater than or equal to 0')
      );
    }
  );
  ...
  t.test("should not validate Float with invalid floatTestData.float1", (t) => {
    ...
    validateDataAgainstJoiValidation(
      floatTestData,
      protobufToJoi.Float
    ).catch((err) => t.equal(err.message, '"float1" must be a number'));
  });
  ...
  t.test(
    "should not validate Packed with invalid packedTestData.packed",
    (t) => {
      t.plan(1);
      ...
      ).catch((err) => t.equal(err.message, '"packed[0]" must be a string'));
    }
  );
  ...
  t.test("should not validate Packed with invalid packedTestData.list", (t) => {
    ...
    validateDataAgainstJoiValidation(
      packedTestData,
      protobufToJoi.Packed
    ).catch((err) => t.equal(err.message, '"list[1].num" must be a number'));
  });
  ...
  t.test(
    ...
    (t) => {
      ...
      ).catch((err) => t.equal(err.message, '"id[0]" must be a number'));
    }
  );
  ...
  t.test(
    "should not validate Property with propertyTestData.bool_value",
    (t) => {
      t.plan(1);
      ...
      ).catch((err) => t.equal(err.message, '"bool_value" must be a boolean'));
    }
  );
  ...
  t.test(
    ...
    (t) => {
      ...
      validateDataAgainstJoiValidation(
        propertyTestData,
        protobufToJoi.Property
      ).catch((err) => t.equal(err.message, '"int32_value" is not allowed'));
    }
  );
  ...
  t.test(
    "should validate PropertyNoOneof with propertyNoOneofTestData",
    (t) => {
      t.plan(1);
  ...
  t.test("should not validate empty strings", (t) => {
    ...
    validateDataAgainstJoiValidation(
      utf8TestData,
      protobufToJoi.UTF8
    ).catch((err) => t.equal(err.message, '"foo" is not allowed to be empty'));
  });
  ...
  t.test("should validate recursively nested messages", (t) => {
    t.plan(1);
    ...
    validateDataAgainstJoiValidation(valueTestData, protobufToJoi.Value)
      .then((res) => t.deepEqual(res, valueTestData))
      .catch((err) => console.error(err));
  });
